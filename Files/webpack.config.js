...
const entryPoints = ["inline","polyfills","sw-register","vendor","background","shelf"];
...
module.exports = {
  ...
  "plugins": [
    ...
    new CopyWebpackPlugin([
      ...
      {
        "from": path.join(process.cwd(), "manastorm"),
        "to": "manastorm"
      },
      {
    ...
    new HtmlWebpackPlugin({
      ...
      "chunks": "all",
      "excludeChunks": ["shelf"],
      "title": "Manastorm - background app",
      "xhtml": true,
    ...
    new HtmlWebpackPlugin({
      "template": "./src\\html\\shelf.html",
      "filename": "./html\\shelf.html",
      "hash": false,
      "inject": true,
      "compile": true,
      "favicon": false,
